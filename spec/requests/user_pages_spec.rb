...
describe "UserPages" do
	...
	describe "following/followers" do
		...
		let(:other_user) { create_user email: 'other_user@example.com' }
	...
	describe "index" do
		...
		it { should have_title_and_content('All users', 'All users') }
	...
	describe "edit" do
		...
		describe "page" do
			it { should have_title_and_content("Edit user", "Update your profile") }
	...
	describe "profile page" do
		...
		describe "microposts" do
			it { should have_contents(m1.content, m2.content, user.microposts.count) }
		end
